...
│   对于空间坐标 (s_x, s_y):                                          │
│                                                                     │
│   PE^(2i)_(s_x,s_y) = sin(s_x / 10000^(2i/d_model))                │
│                      + sin(s_y / 10000^(2i/d_model))                │
│                                                                     │
│   PE^(2i+1)_(s_x,s_y) = cos(s_x / 10000^(2i/d_model))              │
│                        + cos(s_y / 10000^(2i/d_model))              │
│                                                                     │
│   其中:                                                             │
│   - i: 维度索引                                                     │
│   - d_model: 模型维度                                               │
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│   SpatialAttn_ij = (Q_i·K_j^T)/√d_k - λ·||s_i - s_j||₂             │
│                                                                     │
│   其中:                                                             │
│   - Q, K: 查询和键向量                                              │
│   - s_i, s_j: 细胞i和j的空间坐标                                    │
...
│   门控网络 (Top-K 稀疏路由):                                        │
│                                                                     │
│   g_k(x) = exp(w_k^T·x) / Σ exp(w_j^T·x)  ·  1_{k∈TopK}            │
│                     j∈TopK                                          │
│                                                                     │
│   优势: 不同区域由不同专家处理，提高异质性建模能力                  │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
