...
│   │  基因表达文本化   │      │  网络边文本化     │                   │
│   │                  │      │                  │                   │
│   │  "Cell expresses │      │  "Protein A      │                   │
│   │   high CD4,      │      │   interacts with │                   │
│   │   moderate IL2"  │      │   Protein B"     │                   │
│   └────────┬─────────┘      └────────┬─────────┘                   │
│            │                         │                             │
│            └───────────┬─────────────┘                             │
│                        ▼                                           │
...
│   │                                                     │         │
│   │   单细胞嵌入 ──┐                                    │         │
│   │                ├──→ Cross-Attention ──→ 融合表示   │         │
│   │   PPI嵌入 ────┘                                    │         │
│   │                                                     │         │
│   │   h_fused = LayerNorm(α·h_scRNA + (1-α)·h_PPI      │         │
│   │              + CrossAttn(h_scRNA, h_PPI))           │         │
│   └─────────────────────────────────────────────────────┘         │
│                        ↓                                           │
│   ┌─────────────────────────────────────────────────────┐         │
│   │              输出层                                  │         │
